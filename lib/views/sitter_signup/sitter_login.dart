                  ...
                  child: Consumer<SitterController>(
                    builder: (context, provider, _) {
                      return Padding(
                        ...
                        child: Form(
                          key: provider.sitterLoginFormKEy,
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: provider.sitterEmailLoginController,
                              ...
                              TextFormField(
                                controller:
                                    provider.sitterpasswordLoginController,
                                obscureText: true,
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return '*this field is required';
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    if (provider
                                        .sitterLoginFormKEy.currentState!
                                        .validate()) {
                                      provider.sitterLogin(
                                          provider
                                              .sitterEmailLoginController.text,
                                          provider.sitterpasswordLoginController
                                              .text,
                                          context);
                                    }
